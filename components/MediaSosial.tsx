...
const MediaSosial = () => {
  ...
  return (
    <div>
      <section className="coaching-single pt-10 pb-130">
                  ...
                  >
                    <li className="nav-item" role="presentation">
                      <a
                        ...
                        id="xbc-fb"
                        data-bs-toggle="tab"
                        data-bs-target="#xbc-tab-fb"
                        type="button"
                        role="tab"
                        aria-controls="xbc-tab-fb"
                        aria-selected="true"
                      >
                        Facebook
                        <span>
                    ...
                    <li className="nav-item" role="presentation">
                      <a
                        ...
                        id="xbc-ig"
                        data-bs-toggle="tab"
                        data-bs-target="#xbc-tab-ig"
                        type="button"
                        role="tab"
                        aria-controls="xbc-tab-ig"
                        aria-selected="true"
                      >
                        Instagram
                        <span>
                    ...
                    <li className="nav-item" role="presentation">
                      <a
                        ...
                        id="xbc-yt"
                        data-bs-toggle="tab"
                        data-bs-target="#xbc-tab-yt"
                        type="button"
                        role="tab"
                        aria-controls="xbc-tab-yt"
                        aria-selected="true"
                      >
                        Youtube
                        <span>
                    ...
                    <div className="row">
                      ...
                      >
                        <div
                          ...
                          data-tabs="timeline"
                          data-width="1080"
                          data-height="700" // Set the height to prevent scrolling
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    <div className="item">
                      <blockquote
                        ...
                        data-instgrm-permalink="https://www.instagram.com/p/DAVOXe0PtsD/?utm_source=ig_embed&utm_campaign=loading"
                        data-instgrm-version={14}
                        style={{
                          background: "#FFF",
                          border: 0,
                          height: "439px", // Adjust the height to prevent scrolling
                          borderRadius: 3,
                          boxShadow:
                      ...
                      >
                        <div style={{ padding: 16 }}>
                          {" "}
                          <a
                            href="https://www.instagram.com/p/DAVOXe0PtsD/?utm_source=ig_embed&utm_campaign=loading"
                            style={{
                              background: "#FFFFFF",
                              lineHeight: 0,
                              padding: "0 0",
                          ...
                          >
                            <a
                              ...
                              target="_blank"
                            >
                              A post shared by Panca Wijaya Akbar
                              (@pancawijayaakbar)
                            </a>
                          </p>
                        </div>
                    ...
                    <div className="item">
                      <blockquote
                        className="instagram-media"
                        data-instgrm-permalink="https://www.instagram.com/p/C-xY6-DP_6G/?utm_source=ig_embed&utm_campaign=loading"
                        data-instgrm-version={14}
                        style={{
                          background: "#FFF",
                          border: 0,
                      ...
                      >
                        <div style={{ padding: 16 }}>
                          {" "}
                          <a
                            href="https://www.instagram.com/p/C-xY6-DP_6G/?utm_source=ig_embed&utm_campaign=loading"
                            style={{
                              background: "#FFFFFF",
                              lineHeight: 0,
                              padding: "0 0",
                  ...
                  <div className="row">
                    <div className="col-12 col-lg-4">
                      <iframe
                        width={250}
                        height={450}
                        src="https://www.youtube.com/embed/QxCB_dmgNqA?si=PubiysFmo15seW0e"
                    ...
                    <div className="col-12 col-lg-4">
                      <iframe
                        width={250}
                        height={450}
                        src="https://www.youtube.com/embed/whRcjZw8_uA?si=Sfg-RgRazg4CDJA8"
                        title="YouTube video player"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      />
                    </div>
